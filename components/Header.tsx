                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="nav navbar-nav ms-auto navbar-nav-scroll">
                        <li className="nav-item">
                            <Link href="/elagage" ><a className={`nav-link ${router.pathname == "/elagage" ? "active" : ""}`} >Élagage</a></Link>
                        </li>
                        <li className="nav-item">
                            <Link href="/bois-de-chauffage"><a className={`nav-link ${router.pathname == "/bois-de-chauffage" ? "active" : ""}`} >Bois de chauffage</a></Link>
                        </li>
                        <li className="nav-item">
                            <Link href="/mini-pelle"><a className={`nav-link ${router.pathname == "/mini-pelle" ? "active" : ""}`} >Mini-pelle</a></Link>
                        </li>
                        <li className="nav-item">
                            <Link href="/contact"><a className={`nav-link ${router.pathname == "/contact" ? "active" : ""}`} >Contact</a></Link>
                        </li>
                    </ul>
                </div>
            </div>
