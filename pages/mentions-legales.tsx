      ...
      <div className="main">
        <div className="container-fluid py-m pt-xl">
          <div className="container row align-items-stretch justify-content-center">
            ...
            <h2>Hébergement</h2>
            <p><strong>O2Switch</strong><br></br>222 Boulevard Gustave Flaubert<br></br>63000 Clermont-Ferrand<br></br>Tél :<a href="tel:0444446040"> (+33) 4 44 44 60 40</a> </p>
            ...
            <p>Le propriétaire du site ne peut être tenu responsable des dommages directs et indirects consécutifs à l’accès au site.</p><h2>Interactivité</h2>
