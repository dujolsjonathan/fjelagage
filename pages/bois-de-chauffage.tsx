          ...
          <div className="container row align-items-center justify-content-center">
            ...
            <div className="col-md-4 order-md-1 mb-md-m pr-0 ">
              <div className='image-container'>
                <Image src={FeuDeBois} alt="Bois de chauffage fjelagage.fr" width="100%" height="100%" layout="responsive" objectFit='cover' />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid py-md-3">
          <div className="container row align-items-center justify-content-center">
            ...
            <div className="col-md-6 order-md-1 mb-md-m pr-0 ">
              <div className='image-container'>
                <Image src={wood} alt="Bois de chauffage chêne fjelagage.fr" width="100%" height="60%" layout="responsive" objectFit='cover' />
              </div>
            </div>
          </div>
        </div>
        <div className="container-fluid py-md-3">
          <div className="container row align-items-center justify-content-center">
            ...
            <div className="col-md-6 order-md-2 mb-md-m pr-0 ">
              <div className='image-container'>
                <Image src={wood} alt="Bois de chauffage mélange fjelagage.fr" width="100%" height="60%" layout="responsive" objectFit='cover' />
              </div>
            </div>
          </div>
        </div>
