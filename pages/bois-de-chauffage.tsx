        ...
        {/* Intro */}
          <div className="container row justify-content-center">
            <div className="col-md-12 order-md-2 p-s d-flex flex-column justify-content-center">
              <p className="intro">Le bois de chauffage reste à l'heure actuelle l'un des systèmes de chauffage les plus en vogue. FJ Elagage s'engage à vous livrer dans les délais les plus court. Bien qu'en stock la grande majorité de l'année n'attendez pas le dernier moment pour commander !<br></br>Un hiver se prépare à l'avance !</p>
