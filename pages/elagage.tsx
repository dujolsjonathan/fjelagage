        ...
        <BackgroundIcon className="background-icon elagage"/>
          <div className="container row align-items-center justify-content-center">
            <div className="col-md-7 order-md-2 mb-m ps-md-5 d-flex flex-column justify-content-center">
              ...
              <p>FJ É intervient rapidement en urgence.</p>
            ...
            <div className="col-md-5 order-md-1 mb-md-m pr-0 ">
              <div className='image-container'>
                <Image src={Elagage2} alt="Élagage pour les entreprises fjelagage.fr" width="100%" height="70%" layout="responsive" objectFit='cover' />
              </div>
              {/* <PictoPro /> */}
            </div>
          </div>
